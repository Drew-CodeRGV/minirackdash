#!/usr/bin/env python3
"""
AWS EC2 Free Tier Deployment for MiniRack Dashboard
Cost: FREE for 12 months (t2.micro)
"""

def create_ec2_user_data():
    """Create EC2 user data script for automatic deployment"""
...
if __name__ == "__main__":
    ...
    with open("aws_deployment/ec2_user_data.sh", "w") as f:
        f.write(create_ec2_user_data())
    
    with open("aws_deployment/EC2_INSTRUCTIONS.md", "w") as f:
        f.write(create_ec2_instructions())
    
    print("✓ EC2 deployment files created!")